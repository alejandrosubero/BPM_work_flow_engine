...
import com.js.employee.entitys.EmployeeRelief;import java.util.regex.Pattern;
import org.springframework.stereotype.Service;
import com.js.employee.pojo.EmployeeReliefPojo;


    @Service
    public class EmployeeReliefValidation {

        public EmployeeReliefPojo valida(EmployeeReliefPojo employeerelief) {
        EmployeeReliefPojo pojo = null;
        try {
             if (employeerelief != null) {
              if (
        employeerelief.getEmployeeToBeRelieved() != null &&
        employeerelief.getEmployeeRelief() != null        ) {
        pojo = employeerelief;
         }
        }
            return pojo;
