...
@Service
public class InstanceStageValidation {

    public InstanceStageModel valida(InstanceStageModel instancestage) {
        InstanceStageModel pojo = null;
        try {
            if (instancestage != null) {
                if (
                        instancestage.getState() != null &&
                                instancestage.getName() != null &&
                                instancestage.getProcesCode() != null &&
                                instancestage.getTitle() != null) {
                    pojo = instancestage;
                }
            }
            return pojo;
