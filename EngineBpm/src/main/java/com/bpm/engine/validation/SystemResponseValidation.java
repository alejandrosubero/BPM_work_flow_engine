...
import com.bpm.engine.entitys.SystemResponse;import java.util.regex.Pattern;
import org.springframework.stereotype.Service;
import com.bpm.engine.model.SystemResponseModel;


    @Service
    public class SystemResponseValidation {

        public SystemResponseModel valida(SystemResponseModel systemresponse) {
        SystemResponseModel pojo = null;
        try {
             if (systemresponse != null) {
              if (
        systemresponse.getResponse() != null        ) {
        pojo = systemresponse;
         }
        }
            return pojo;
