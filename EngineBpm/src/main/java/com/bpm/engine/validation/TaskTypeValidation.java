...
import com.bpm.engine.entitys.TaskType;import java.util.regex.Pattern;
import org.springframework.stereotype.Service;
import com.bpm.engine.model.TaskTypeModel;import com.bpm.engine.model.TaskTypeModel;


    @Service
    public class TaskTypeValidation {

        public TaskTypeModel valida(TaskTypeModel tasktype) {
        TaskTypeModel pojo = null;
        try {
             if (tasktype != null) {
              if (
        tasktype.getType() != null        ) {
        pojo = tasktype;
         }
        }
            return pojo;
