...
import com.bpm.engine.model.TaskEmailModel;import com.bpm.engine.model.TaskEmailModel;
    ...
    @Service
    public class TaskEmailValidation {

        public TaskEmailModel valida(TaskEmailModel taskemail) {
        TaskEmailModel pojo = null;
        try {
             if (taskemail != null) {
              if (
        taskemail.getEmailFrom() != null &&
        taskemail.getNota() != null &&
        taskemail.getTempleCode() != null &&
        taskemail.getEmailTo() != null &&
        taskemail.getEmailCC() != null &&
        taskemail.getNumberRepete() != null &&
        taskemail.getRepete() != null        ) {
        pojo = taskemail;
         }
        }
            return pojo;
