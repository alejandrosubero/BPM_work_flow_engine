...
@Service
public class InstanceTaskValidation {

    public InstanceTaskModel valida(InstanceTaskModel instancetask) {
        InstanceTaskModel pojo = null;
        try {
            if (instancetask != null) {
                if (
                        instancetask.getName() != null &&
                                instancetask.getState() != null &&
                                instancetask.getDateStart() != null &&
                                instancetask.getDateEnd() != null &&
                                instancetask.getProcessCode() != null &&
                                instancetask.getInstanceProcessCode() != null &&
                                instancetask.getCodeTask() != null ) {
                    pojo = instancetask;
                }
            }
            return pojo;
