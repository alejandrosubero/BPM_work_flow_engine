...
import com.bpm.engine.entitys.InstanceTaskEmail;import com.bpm.engine.model.InstanceTaskEmailModel;
...
public interface InstanceTaskEmailService{
		...
		public List<InstanceTaskEmailModel>  findByEmailToContaining(String	emailTo);				public List<InstanceTaskEmailModel>  findByEmailCCContaining(String	emailCC);				public List<InstanceTaskEmailModel>  findByEmailFromContaining(String	emailFrom);				public List<InstanceTaskEmailModel>  findByNotaContaining(String	nota);				public List<InstanceTaskEmailModel>  findByTempleCodeContaining(String	templeCode);				public List<InstanceTaskEmailModel>  findByDateCreateContaining(Date	dateCreate);				public List<InstanceTaskEmailModel>  findByDateEndContaining(Date	dateEnd);				public List<InstanceTaskEmailModel>  findByDateSentContaining(Date	dateSent);				public List<InstanceTaskEmailModel>  findByRepeteContaining(Boolean	repete);				public List<InstanceTaskEmailModel>  findByNumberRepeteContaining(Integer	numberRepete);				public	InstanceTaskEmailModel findById(Long id);
