...
import com.bpm.engine.entitys.TaskEmail;import com.bpm.engine.model.TaskEmailModel;
...
public interface TaskEmailService{
		...
		public List<TaskEmailModel>  findByEmailFromContaining(String	emailFrom);				public List<TaskEmailModel>  findByNotaContaining(String	nota);				public List<TaskEmailModel>  findByTempleCodeContaining(String	templeCode);				public List<TaskEmailModel>  findByEmailToContaining(String	emailTo);				public List<TaskEmailModel>  findByEmailCCContaining(String	emailCC);				public List<TaskEmailModel>  findByNumberRepeteContaining(Integer	numberRepete);				public List<TaskEmailModel>  findByRepeteContaining(Boolean	repete);				public	TaskEmailModel findById(Long id);
