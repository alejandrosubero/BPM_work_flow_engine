...
private RoleRepository rolerepository;
	...
	Optional<Role> fileOptional2 = rolerepository.findById(role.getIdRole());
		...
		logger.info("Execute Description Containing" );		List<RoleModel> listaRole = new ArrayList<RoleModel>();
		...
		logger.info("Execute Name Containing" );		List<RoleModel> listaRole = new ArrayList<RoleModel>();
		...
		logger.info("Execute CodeRole Containing" );		List<RoleModel> listaRole = new ArrayList<RoleModel>();
