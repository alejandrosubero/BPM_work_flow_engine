...
protected static final Log logger = LogFactory.getLog(StateServiceImplement.class);
@Autowired
private StateRepository staterepository;
	...
	Optional<State> fileOptional2 = staterepository.findById(state.getIdState());
		...
		logger.info("Execute TheState Containing" );		List<StateModel> listaState = new ArrayList<StateModel>();
