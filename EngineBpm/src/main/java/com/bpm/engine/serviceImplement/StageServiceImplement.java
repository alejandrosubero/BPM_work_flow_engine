...
private StageRepository stagerepository;
	...
	Optional<Stage> fileOptional2 = stagerepository.findById(stage.getIdStage());
		...
		logger.info("Execute StageCode Containing" );		List<StageModel> listaStage = new ArrayList<StageModel>();
		...
		logger.info("Execute Name Containing" );		List<StageModel> listaStage = new ArrayList<StageModel>();
		...
		logger.info("Execute Title Containing" );		List<StageModel> listaStage = new ArrayList<StageModel>();
		...
		logger.info("Execute DateCreate Containing" );		List<StageModel> listaStage = new ArrayList<StageModel>();
		...
		logger.info("Execute Type Containing" );		List<StageModel> listaStage = new ArrayList<StageModel>();
		...
		logger.info(" Execute Stage Containing ");				List<StageModel> listaStage = new ArrayList<StageModel>();
		...
		logger.info(" Execute Role Containing ");				List<StageModel> listaStage = new ArrayList<StageModel>();
				for (StageModel	stage : this.getAllStage()) {
		...
		logger.info(" Execute Task Containing ");				List<StageModel> listaStage = new ArrayList<StageModel>();
				for (StageModel	stage : this.getAllStage()) {
