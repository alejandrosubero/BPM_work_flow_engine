...
protected static final Log logger = LogFactory.getLog(TaskEmailServiceImplement.class);
@Autowired
private TaskEmailRepository taskemailrepository;
	...
	Optional<TaskEmail> fileOptional2 = taskemailrepository.findById(taskemail.getIdEmail());
		...
		logger.info("Execute EmailFrom Containing" );		List<TaskEmailModel> listaTaskEmail = new ArrayList<TaskEmailModel>();
		...
		logger.info("Execute Nota Containing" );		List<TaskEmailModel> listaTaskEmail = new ArrayList<TaskEmailModel>();
		...
		logger.info("Execute TempleCode Containing" );		List<TaskEmailModel> listaTaskEmail = new ArrayList<TaskEmailModel>();
		...
		logger.info("Execute EmailTo Containing" );		List<TaskEmailModel> listaTaskEmail = new ArrayList<TaskEmailModel>();
		...
		logger.info("Execute EmailCC Containing" );		List<TaskEmailModel> listaTaskEmail = new ArrayList<TaskEmailModel>();
		...
		logger.info("Execute NumberRepete Containing" );		List<TaskEmailModel> listaTaskEmail = new ArrayList<TaskEmailModel>();
		...
		logger.info("Execute Repete Containing" );		List<TaskEmailModel> listaTaskEmail = new ArrayList<TaskEmailModel>();
