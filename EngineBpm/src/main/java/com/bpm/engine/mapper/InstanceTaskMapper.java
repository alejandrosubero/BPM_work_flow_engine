...
import org.modelmapper.ModelMapper;
    ...
    @Component
    public class InstanceTaskMapper {
    ...
    public InstanceTaskModel entityToPojo(InstanceTask entity) {
 		ModelMapper modelMapper = new ModelMapper();
        InstanceTaskModel pojo = null;

		if ( entity != null) {
			pojo = modelMapper.map(entity, InstanceTaskModel.class);
       }
	return  pojo;
}
    public InstanceTask pojoToEntity(InstanceTaskModel pojo) {
		ModelMapper modelMapper = new ModelMapper();
        InstanceTask entity = null;

		if ( pojo != null) {
   		entity = modelMapper.map(pojo, InstanceTask.class);
		}
	return  entity;
}
}
